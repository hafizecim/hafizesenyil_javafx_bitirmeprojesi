...
module com.hafizesenyil.hafizesenyil_javafx_bitirmeprojesi {
    ...
    opens com.hafizesenyil.hafizesenyil_javafx_bitirmeprojesi.dto to javafx.base, lombok;

    // Controller sınıfları FXML tarafından kullanılacağı için açılması gerekiyor.
    opens com.hafizesenyil.hafizesenyil_javafx_bitirmeprojesi.controller to javafx.fxml;

    // DAO (Data Access Object) sınıfları, SQL bağlantısı kullandığı için açılıyor.
    opens com.hafizesenyil.hafizesenyil_javafx_bitirmeprojesi.dao to java.sql;

    // Veritabanı bağlantısı sağlayan sınıfların da SQL modülüne açık olması gerekiyor.
    opens com.hafizesenyil.hafizesenyil_javafx_bitirmeprojesi.database to java.sql;
    ...
    exports com.hafizesenyil.hafizesenyil_javafx_bitirmeprojesi.dao;

    // // Veritabanı bağlantı paketini dış dünyaya açıyoruz. Diğer modüller DB bağlantısını kullanabilir.
    exports com.hafizesenyil.hafizesenyil_javafx_bitirmeprojesi.database;
    ...
    opens com.hafizesenyil.hafizesenyil_javafx_bitirmeprojesi.utils to javafx.base, lombok;
}
